                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="user-dropdown">
                                <div class="user-dropdown-head">
                                    <h6 class="user-dropdown-name"><?php echo $duser->u_name;?></h6>
                                </div>
            ...
            <div class="d-flex">
                <div class="user-sidebar">
                    ...
                    <div class="user-box d-none d-lg-block">
                        ...
                        <h6 class="user-name"><?php echo $duser->u_name?></h6>
                        <div class="user-uid">Legit Shop Code: <span><?php echo $duser->u_key?></span></div>
                    </div><!-- .user-box -->
                    <ul class="user-icon-nav">
                        <li><a href="dashboard"><em class="ti ti-dashboard"></em>Dashboard</a></li>
                        <?php if($duser->is_vendor==0){  ?>
                        <li><a href="kyc"><em class="ti ti-files"></em>Become a Verified Seller  </a></li>
                        <?php } else { ?>

                        <li><a href="application-status"><em class="ti ti-files"></em> Application Status  </a></li>
                        <li><a href="loan-application"><em class="ti ti-pie-chart"></em>Apply for Loan</a></li>
                    ...
                    <ul class="user-nav">
                        <li><a href="https://instagram.com/legitshopng">Reach Us on Instagram</a></li>
                        <li><a href="<?php echo base_url()?>#faq">Faqs</a></li>
                        <li>Contact Support<span>info@legitshop.com.ng</span></li>
                    </ul><!-- .user-nav -->
                    <div class="d-lg-none">
